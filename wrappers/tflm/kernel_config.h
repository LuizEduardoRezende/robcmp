...
// Inventario de kernels conferido contra o TFLM no commit d0318206
// (third-party/tflite-micro, main de 2026-09-11), cruzando cada flag
// ENABLE_* com os metodos Add* de micro_mutable_op_resolver.h.
//
// Numeros dessa conferencia: 121 metodos Add* no TFLM; 99 com case no
// switch de RegisterOp; 19 disponiveis e ausentes deste arquivo (secao
// ao final); 108 flags corretamente marcadas como nao suportadas.
...
#define ENABLE_CUSTOM 0 //Nao e kernel: AddCustom() e o mecanismo generico de registro por string. Flag sem uso no wrapper.
...
#define ENABLE_REDUCE_ALL 0 //Suportado: resolver->AddReduceAll() (builtin)
...
#define ENABLE_DYNAMIC_UPDATE_SLICE 0 //Suportado: resolver->AddDynamicUpdateSlice() (builtin)
...
// ---------------------------------------------------------------------------
// Kernels disponiveis no TFLM e AUSENTES do enum KernelType deste wrapper.
//
// Motivo da ausencia: KernelType espelha o enum BuiltinOperator do schema do
// TF Lite, e estes operadores nao sao builtin -- sao custom ops, registrados
// por string via AddCustom(). No arquivo .tflite eles aparecem em
// OperatorCode.custom_code, nunca em OperatorCode.builtin_code.
//
// ATENCAO: ligar qualquer flag abaixo NAO tem efeito hoje. Nao existe case
// correspondente no switch de RegisterOp nem membro no enum KernelType.
// Esta secao e um inventario do que o TFLM oferece, nao configuracao ativa.
//
// A coluna a direita e a string de custom_code usada no registro -- e por ela
// que a analise estatica do .tflite tera de casar estes operadores.
// ---------------------------------------------------------------------------

// Processamento de sinal (pipeline de audio -- usados pelo Micro Speech)
#define ENABLE_RFFT 0                               //AddRfft()                          -> "SignalRfft"
#define ENABLE_IRFFT 0                              //AddIrfft()                         -> "SignalIrfft"
#define ENABLE_FFT_AUTO_SCALE 0                     //AddFftAutoScale()                  -> "SignalFftAutoScale"
#define ENABLE_WINDOW 0                             //AddWindow()                        -> "SignalWindow"
#define ENABLE_FRAMER 0                             //AddFramer()                        -> "SignalFramer"
#define ENABLE_ENERGY 0                             //AddEnergy()                        -> "SignalEnergy"
#define ENABLE_STACKER 0                            //AddStacker()                       -> "SignalStacker"
#define ENABLE_OVERLAP_ADD 0                        //AddOverlapAdd()                    -> "SignalOverlapAdd"
#define ENABLE_DELAY 0                              //AddDelay()                         -> "SignalDelay"
#define ENABLE_PCAN 0                               //AddPCAN()                          -> "SignalPCAN"
#define ENABLE_FILTER_BANK 0                        //AddFilterBank()                    -> "SignalFilterBank"
#define ENABLE_FILTER_BANK_LOG 0                    //AddFilterBankLog()                 -> "SignalFilterBankLog"
#define ENABLE_FILTER_BANK_SQUARE_ROOT 0            //AddFilterBankSquareRoot()          -> "SignalFilterBankSquareRoot"
#define ENABLE_FILTER_BANK_SPECTRAL_SUBTRACTION 0   //AddFilterBankSpectralSubtraction() -> "SignalFilterBankSpectralSubtraction"

// Outros custom ops
#define ENABLE_CIRCULAR_BUFFER 0                    //AddCircularBuffer()                -> "CIRCULAR_BUFFER"
#define ENABLE_DETECTION_POSTPROCESS 0              //AddDetectionPostprocess()          -> "TFLite_Detection_PostProcess"
#define ENABLE_BASIC_CLASSIFIER 0                   //AddBasicClassifier()               -> "BasicClassifier"
#define ENABLE_DECODE 0                             //AddDecode()                        -> "TFLM_DECODE"
#define ENABLE_ETHOS_U 0                            //AddEthosU()                        -> GetString_ETHOSU() (acelerador Arm Ethos-U; no-op se ausente)
